...
class CategorySerializer(serializers.ModelSerializer):
    ...
    product_count = serializers.IntegerField(
        read_only=True, help_text="Return the number of product in this category") # read_only=True দ্বারা বুঝায় এটি শুধুমাত্র গেট করার সময় কাজ করবে কিন্তু post এর সময় কাজ করবে না।
